...
#    Updated: 2019/09/11 19:48:59 by vrichese         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LFT_DIR := source/libs/libft

LFTPRINTF_DIR := source/libs/ft_printf

HEADERS := lemin.h lemin_visualizer.h libft.h ft_printf.h SDL.h SDL_ttf.h

HEADERS_DIR := include $(LFT_DIR) $(LFTPRINTF_DIR)/includes source/libs/sdl2/include/SDL2 source/libs/sdl2_ttf/include/SDL2
